...
- `update.json`: desktop update manifest used by the app.
- `runtime-assets.json`: optional runtime asset mirror manifest.
- GitHub Releases: Windows and Linux installer/package assets.
